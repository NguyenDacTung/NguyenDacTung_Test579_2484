...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(190, 20, 431, 111))
        font = QtGui.QFont()
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 140, 101, 31))
        font = QtGui.QFont()
        ...
        self.label_5.setGeometry(QtCore.QRect(20, 240, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_information.setGeometry(QtCore.QRect(110, 150, 641, 71))
        self.txt_information.setObjectName("txt_information")
        self.txt_signature = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_signature.setGeometry(QtCore.QRect(110, 260, 641, 181))
        self.txt_signature.setObjectName("txt_signature")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(470, 460, 131, 51))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(620, 460, 131, 51))
        self.btn_verify.setObjectName("btn_verify")
        self.btn_generate_keys = QtWidgets.QPushButton(self.centralwidget)
        self.btn_generate_keys.setGeometry(QtCore.QRect(110, 460, 131, 51))
